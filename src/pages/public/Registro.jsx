          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <label className="flex items-start gap-3 cursor-pointer">
              ...
              <span className="text-xs text-slate-600 leading-relaxed">
                ...
                <Link to="/terminos" className="text-blue-600 font-semibold hover:underline">Términos y Condiciones</Link>{' '}

                y la{' '}

                <Link to="/privacidad" className="text-blue-600 font-semibold hover:underline">Política de Privacidad</Link>
