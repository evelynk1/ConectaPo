...
export default function CrearTicket() {
  ...
  const handleSubmit = async (e) => { 
    e.preventDefault();
    if (!form.user || !form.category || !form.subject) {
            ...
            <form onSubmit={handleSubmit} className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="flex gap-3 pt-2">
                  <button type="submit"
                    className="flex-1 py-3.5 rounded-xl text-white font-semibold text-sm transition-all hover:opacity-90 hover:shadow-lg cursor-pointer"
